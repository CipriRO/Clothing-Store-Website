...
async function ready() {
  ...
  for (var i = 0; i < categories.length; i++) {
    ...
    var products = productsList.getElementsByClassName("product-preview");
    if (products.length > 4) {
      autoColapseProducts(products);
    }
  }
  ...
  return new Promise((resolve, reject) => {
    fetch("http://192.168.1.17:8000/src/products%20php/getProductsById.php", {
      ...
      .then(async (data) => {
        ...
        <div class="delete-cart-product-button" data-id="${data.product_id}"><img src="../icons/delete-icon.png"></div>`;
      ...
      fetch(
        ...
        .then(async (data) => {
          ...
          let cartRowContent = `
            ...
            <div class="delete-cart-product-button" data-id="${data["products"].product_id}"><img src="../icons/delete-icon.png"></div>`;
          cartRow.innerHTML = cartRowContent;
          cartProducts.append(cartRow);
          cartRow
            .getElementsByClassName("delete-cart-product-button")[0]
